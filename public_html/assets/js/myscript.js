...
// =========== dashboard_page selecting #account tab page contents
	$("#dashboard #account .row.row8 .leftLinks ul li a").on("click", function(){
		...
		if(getTheConvertedId1 === "contactinfo"){
			...
			$("#affiliates").addClass("displayingOff").removeClass("displayingOn");
			$("#changepaypalemail").addClass("displayingOff").removeClass("displayingOn");
			$("#billing").removeClass("displayingOff").addClass("displayingOn");
		 }
...
// =========== freshair_page selecting navigationz
	$("#fresh_airMain .navigationz li a").on("click", function(z){

		$("#fresh_airMain .navigationz li a").removeClass("active");
		var getAnchor = $(this);
		getAnchor.addClass("active");

		var getTheConvertedId = getAnchor.text().toLowerCase().replace(" ","");

		if(getTheConvertedId === "overview"){
			$("#features").addClass("displayingOff").removeClass("displayingOn");
			$("#specifications").addClass("displayingOff").removeClass("displayingOn");
			$("#overview").removeClass("displayingOff").addClass("displayingOn");
		} else if(getTheConvertedId === "features"){
			$("#specifications").addClass("displayingOff").removeClass("displayingOn");
			$("#overview").addClass("displayingOff").removeClass("displayingOn");
		 	$("#features").removeClass("displayingOff").addClass("displayingOn");
		 } else{
	 		$("#features").addClass("displayingOff").removeClass("displayingOn");
		 	$("#overview").addClass("displayingOff").removeClass("displayingOn");
		 	$("#specifications").removeClass("displayingOff").addClass("displayingOn");	
		 }
